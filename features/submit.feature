Feature: Writers submit a poem to be reviewed by an admin
 
    As a writer
    So that I can submit my poem to the gallery for viewers to see
    I want to add to CApoets
...
Scenario: I can't submit a form with missing fields 
  Given I am a user on the "new poem" page who wants to "submit a poem"
  And I fill in input box "Poet Teacher Name" with "Alexander Camelton"
  And I fill in input box "Email" with "Email@email.com"
  And I fill in input box "Student Name" with "Student Name"
  And I fill in input box "Poem Title" with "Sample title"
