$(function() {
  //CHA NGE ID OF BUTTON TO MATCH CORRECT ONE
  $('#addStudent').click(function() {
    ...
    newElem.find('.label_attachment').attr('for', 'ID' + newNum + '_imgInp');
    newElem.find('.input_label_attachment').attr('id', 'ID' + newNum + '_imgInp').attr('name', 'ID' + newNum + '_imgInp').src="http://golloscdn.com/common/no-image.jpg"; 
