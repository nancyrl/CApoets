...
Rails.application.config.assets.precompile += %w( admindash.js )
...
Rails.application.config.assets.precompile += %w( submitted.css )
Rails.application.config.assets.precompile += %w( teacherProfile.css )